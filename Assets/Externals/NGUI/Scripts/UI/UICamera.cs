...
public class UICamera : MonoBehaviour
{
	...
	static public bool ignoreControllerInput = true;
    ...
    private UICamera CurrentUICamera
    {
        get
        {
    ...
    private Camera OldCamera
    {
        ...
        {
            m_oldCamera = value;
            m_currentuiCamera = currentCamera.GetComponent<UICamera>();
        }
        get
        {
            return m_oldCamera;
    ...
    public void ProcessTouch (bool pressed, bool released)
	{
        ...
        {
            drag = isMouse ? mouseDragThreshold : touchDragThreshold;
            click = isMouse ? mouseClickThreshold : touchClickThreshold;
        }
        else
        {
            drag = isMouse ? CurrentUICamera.mouseDragThreshold : CurrentUICamera.touchDragThreshold;
            click = isMouse ? CurrentUICamera.mouseClickThreshold : CurrentUICamera.touchClickThreshold;
        }
