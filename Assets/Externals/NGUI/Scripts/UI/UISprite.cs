...
public class UISprite : UIBasicSprite
{
    ...
    /// </summary>
    /// 
    public delegate void ChangeSpriteNameDeleagte(UISprite sprite);
    private ChangeSpriteNameDeleagte m_changespritenameFunc = null;
    public ChangeSpriteNameDeleagte ChangeSpriteNameFunc
    {
        set
        {
            m_changespritenameFunc = value;
        }
        private get
        {
            return m_changespritenameFunc;
        }
    }
    ...
    public string spriteName
	{
		...
		set
		{
            ...
            if (ChangeSpriteNameFunc != null)
                ChangeSpriteNameFunc(this);
        }
	}
