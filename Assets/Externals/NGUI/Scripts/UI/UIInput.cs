...
public class UIInput : MonoBehaviour
{
	...
	public void Set (string value, bool notify = true)
	{
        ...
        bool isStartValue = (string.Compare(StartDefaultStr, value) == 0);
    ...
    /// </summary>
    /// 
    private string StartDefaultStr;

    public void ReturnStartValue()
    {
        label.text = StartDefaultStr;
    }
	...
	public void UpdateLabel ()
	{
		if (label != null)
		{
            ...
            bool isStartValue = (string.Compare(StartDefaultStr, fullText) == 0);
            if (isEmpty)
            {
                label.color = activeTextColor;
            }
